...
# DON'T INCLUDE ICU, INTUBE, PREGNANT TOO MUCH MISSINAG DATA
...
X_undertrain, Y_undertrain =  RandomUnderSampler().fit_resample(all_X,all_Y)
# Split the data
